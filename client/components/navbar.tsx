      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button className="btn-neon text-neon-cyan border-neon-cyan font-body font-semibold">
              Get Started
            </Button>
          </div>
          ...
          <div className="md:hidden bg-background/95 backdrop-blur-md border-t border-border/40">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="pt-4 space-y-2">
                ...
                <Button className="w-full btn-neon text-neon-cyan border-neon-cyan font-semibold">
                  Get Started
                </Button>
              </div>
            </div>
