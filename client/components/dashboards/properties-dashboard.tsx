...
export function PropertiesDashboard() {
  ...
  // Filter properties with priority on ID prefix matches, then ID contains, then other fields
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="card-glow">
        ...
        <CardContent>
          <div className="h-48 bg-card/30 rounded-lg border border-border/30 flex items-center justify-center">
