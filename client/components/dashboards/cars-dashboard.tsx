...
//   // Helper: normalize string for case-insensitive comparison
//   const normalize = (str: string) => str.toLowerCase();

//   // Filter and sort cars to prioritize exact/prefix matches on ID in sequence
//   const filteredCars = React.useMemo(() => {
//     if (!searchQuery.trim()) return carData;

//     const q = normalize(searchQuery);

//     // Cars with ID starting with query (in order)
//     const idPrefixMatches = carData.filter((car) =>
//       normalize(car.id).startsWith(q)
//     );

//     // Cars with ID containing query but not prefix
//     const idContainsMatches = carData.filter(
//       (car) =>
//         normalize(car.id).includes(q) && !normalize(car.id).startsWith(q)
//     );

//     // Cars matching other fields (model, driver, status, location)
...
//     // Combine all, preserving order and uniqueness
...
//                 <div
//                   key={car.id}
//                   className="flex items-center justify-between p-4 bg-card/30 rounded-lg border border-border/30 hover:bg-neon-cyan/10 transition-colors cursor-pointer"
//                 >
...
//                   <div className="flex items-center space-x-6 min-w-[280px] justify-end">
//                     <div className="text-center min-w-[80px]">
//                       <div
//                         className={`flex items-center justify-center space-x-1 ${getStatusColor(
//                           car.status
//                         )}`}
//                       >
...
//                       <div className="flex items-center justify-center space-x-1 text-muted-foreground truncate">
...
//                 Register a new car to your fleet
//               </p>
