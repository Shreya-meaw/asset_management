...
import { fetchCars, addCar, fetchLaptops, addLaptop } from "@/services/assetsService";
...
export function LaptopsDashboard() {
  ...
  const handleAddLaptop = async (data: any) => {
    try {
      const newCar = await addLaptop(data);
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Total Laptops</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {loading ? (
              ...
              <p className="text-center text-muted-foreground py-6">No Laptops found.</p>
            )}
          </div>
        </CardContent>
      </Card>
